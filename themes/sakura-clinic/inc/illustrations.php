 ...
 */
function sakura_clinic_brand_mark( string $class = '' ): string {
	return sprintf(
 ...
 * ヒーローの線画（院の外観）。
 */
function sakura_clinic_hero_art( string $class = '' ): string {
	return sprintf(
 ...
 */
function sakura_clinic_access_map( string $class = '' ): string {
	return sprintf(
